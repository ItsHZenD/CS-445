                ...
                <div id="masthead" class="header-main ">
                    <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                        ...
                        <div id="logo" class="flex-col logo">
                            <!-- Header logo -->
                            <a href="#" title="Casio" rel="home">
    <img src="./assets/images/images_home/logo_casio.png" class="header_logo header-logo" alt="Casio"/><img  width="200" height="96" src="./assets/images/images_home/logo_casio.png" class="header-logo-dark" alt="Casio"/></a>
                        </div>
                                ...
                                <div class="banner has-hover" id="banner-364124233">
                                    ...
                                    <style scope="scope">
                                        ...
                                        #banner-364124233 .bg.bg-loaded {
                                            background-image: url('./assets/images/images_home/slide1.webp');
                                        }
                                ...
                                <div class="banner has-hover" id="banner-364124236">
                                    ...
                                    <style scope="scope">
                                        ...
                                        #banner-364124236 .bg.bg-loaded {
                                            background-image: url('./assets/images/images_home/slide2.webp');
                                        }
                                ...
                                <div class="banner has-hover" id="banner-1859137963">
                                    ...
                                    <style scope="scope">
                                        ...
                                        #banner-1859137963 .bg.bg-loaded {
                                            background-image: url('./assets/images/images_home/slide3.webp');
                                        }
                                ...
                                <div class="banner has-hover" id="banner-1859137962">
                                    ...
                                    <style scope="scope">
                                        ...
                                        #banner-1859137962 .bg.bg-loaded {
                                            background-image: url('./assets/images/images_home/slide4.webp');
                                        }
                                ...
                                <div class="banner has-hover" id="banner-1859137961">
                                    ...
                                    <style scope="scope">
                                        ...
                                        #banner-1859137961 .bg.bg-loaded {
                                            background-image: url('./assets/images/images_home/slide5.webp');
                                        }
                                                ...
                                                <a class="plain" href="">
                                                    <div class="icon-box featured-box icon-box-baner icon-box-left text-left">
                                                        ...
                                                        <div class="icon-box-text last-reset">
                                                            ...
                                                            <p>Sản phẩm được phân phối tại hệ thống cửa hàng tại các thành phố Hà Nội, Đà Nẵng, Hồ Chí Minh,...</p>
                                                    ...
                                                    <div class="hover-blur">
                                                        <div class="text ">
                                                            ...
                                                            <div class="text-inner text-center">
                                                                ...
                                                                <h3 class="txt-baner3">EDIFICE</h3>
                                                                <h2 class="txt-baner3">LIMITED EDITION</h2>
                                                                <p class="txt-baner3">TỐC ĐỘ & THÔNG MINH</p>
                                                    ...
                                                    <div class="hover-blur">
                                                        <div class="text ">
                                                            ...
                                                            <div class="text-inner text-center">
                                                                ...
                                                                <h3 class="txt-baner3">PRO TREK </h3>
                                                                <h2 class="txt-baner3">FEEL THE FIELD</h2>
                                                                <p class="txt-baner3">CẢM NHẬN THIÊN NHIÊN</p>
                ...
                <div class="container clearfix">
                    ...
                    <div class="footer-primary pull-left">
                        <div class="copyright-footer">
                            © Bản quyền thuộc về
                            <công ty khách hàng>. Thiết kế website <img src="./assets/images/images_home/logo_casio.png" style="width:70px;vertical-align:sub;" alt="Casio"> </div>
                    </div>
                    <!-- .left -->
                </div>
                <!-- .container -->
