   ...
   <span class="image-icon header-cart-icon" data-icon-label="<?php if(isset($_SESSION['cart']) && $_SESSION['cart']!=null ){ echo count($_SESSION['cart']);}?>">
    <img class="cart-img-icon" alt="Giỏ hàng" src="http://mauweb.monamedia.net/hachi/wp-content/uploads/2020/05/hd_mainmenu_icon_cart.png"/>
        ...
        <div class="main">
            ...
            <p>
                <span>
                To "invent" the "needs" that do not yet exist. By creating products with unprecedented new work, people are made to feel new "awareness" and "joy". We believe that it will enrich the future society.
                </span>
            </p>
            <p style=" display: block; text-align: center;width:50%;margin-left:25%">
                <img src="./assets/images/images_home/slide2.webp">
            ...
            <p>
                <span>
                Casio hopes to contribute to society in many ways through the provision of products and services.
                </span>
            </p>
            <p style=" display: block; text-align: center;width:50%;margin-left:25%">
                <img src="./assets/images/images_home/slide1.webp">
            ...
            <ul>
                <li> Streamline operations and support management</li>
                <li> Express the image that people have in mind</li>
                <li> Support human activity base</li>
                <li>Promote the growth of people by learning </li>
