...
<head>
    ...
    <style id="custom-css" type="text/css">
        ...
        .nav-tabs>li.active>a {
            border-top-color: #11437c
        }

        .widget_shopping_cart_content .blockUI.blockOverlay:before {
            border-left-color: #11437c
        }
...
<body class="home page-template page-template-page-blank page-template-page-blank-php page page-id-6 theme-flatsome woocommerce-no-js header-shadow lightbox">
                        ...
                        <div class="flex-col hide-for-medium flex-left">
                            <ul class="nav nav-left medium-nav-center nav-small  nav-divided">
                                ...
                                <li class="html custom html_top_right_text">
                                    <p class="mona-html email"><a href="#"><span class="__cf_email__" data-cfemail="a5c8cacbe5c8cacbc48bc8c0c1ccc4">Casio@gmail.com</span></a></p>
                                </li>
    ...
    <img src="./assets/images/images_home/logo_casio.png" class="header_logo header-logo" alt="Menly"/><img  width="200" height="96" src="./assets/images/images_home/logo.png" class="header-logo-dark" alt="Menly"/></a>
                        </div>
		  ...
		  <i class="icon-menu" ></i>
            ...
            flex-grow">
                           ...
                           <?php }?>
                                ...
                                <li id="menu-item-207" class="has-icon-left menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children  menu-item-207 has-dropdown"><a href="" class="nav-top-link"><span class='menu-image-hover-wrapper'><i class="" id="icon-icon"></i></span><span class="menu-image-title-below menu-image-title">Về Casio</span><i class="icon-angle-down" ></i></a>
    ...
    <img class="cart-img-icon" alt="Giỏ hàng" src="http://mauweb.monamedia.net/hachi/wp-content/uploads/2020/05/hd_mainmenu_icon_cart.png"/>
        ...
        <div class="main">
            ...
            <p>
                <strong>
                    <em>
                    Đồng hồ CASIO- NHẬT BẢN của công ty CASIO COMPUTER CO., LTD Tokyo, Japan có địa chỉ  5400-1 Higashine-ko, Higashine-city, Yamagata 999-3701 Japan nổi tiếng trên toàn thế giới nay đã có mặt tại Việt Nam.
                    </em>
                </strong>
               
            </p>
             <p>
             Ra đời từ năm 1957 Nhãn hiệu CASIO có mặt trên thị trường thế giới đã hơn 50 năm qua với nhiều dòng sản phẩm điện tử. Tôn chỉ hoạt động của công ty Casio là
                <strong>
                    <em>
                    "sự sáng tạo và đóng góp".  
                    </em>
                </strong>
                Công việc của Casio là tạo ra các sản phẩm của ngày mai sẽ có một ngày được ở khắp mọi nơi, mà sẽ làm cho tất cả mọi người ngạc nhiên. Các dòng sản phẩm của Casio được sáng tạo dựa trên nhưng nhu cầu cuộc sống hàng ngày của người dân chính vì vậy mà sản phẩm của Casio luôn gần gũi với người sử dụng.
            </p>
            <p>
                Casio Việt Nam với vai trò đại lý đại lý chính hãng đồng hồ Casio tại Việt Nam chính vì vậy mà chúng tôi luôn mang đến cho Quý khách hàng những sản phẩm chất lượng với giá cả phải chăng ngoài ra chúng tôi còn thường xuyên có những chương trình khuyến mãi hấp dẫn mang đến nhiều quyền lợi cho khách hàng. Chế độ hậu mãi chu đáo luôn được Công ty chú trọng, để hỗ trợ quý khách trong quá trình sử dụng và giữ gìn sản phẩm.
            </p>
            
             <p>           
             Casio Việt Nam đơn vị phân phối đồng hồ Casio uy tín với hệ thống chuỗi các cửa hàng từ Bắc vào Nam sẽ mang những sản phẩm chất lượng giá cả phải chăng đến với người tiêu dùng tại Việt Nam. Chúng tôi cam kết những sản phẩm chúng tôi kinh doanh là sản phẩm chính hãng và được bảo hành chính hãng.
            </p>
            
            <p>
            Ngoài bán lẻ tại các cửa hàng, chúng tôi còn cung cấp số lượng lớn đồng hồ Casio chính hãng cho các công ty để làm quà tặng hay chương trình khuyến mãi với chính sách chiết khấu đặc biệt. Ngoài ra chúng tôi còn phục vụ in logo của các công ty nên mặt đồng hồ Casio theo yêu cầu nhằm giúp quảng bá thương hiệu của các công ty đồng hành cùng thương hiệu Casio.
            </p>
            <style>
                .main h1{
                    color:#049372;
                            ...
                            <div class="col-inner">
                                ...
                                <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_1384115679">
                                    <div class="img-inner dark">
                                        <img width="900" height="195" src="./assets/images/images_home/logo_casio.png"
...
<g>
                                    ...
                                    <div class="icon-box-text last-reset">
                                        ...
                                        <p class="txt-footer1"><a class="txt-footer1" href=""><span class="__cf_email__" data-cfemail="4327262e2c2d2b362d3726312403242e222a2f6d202c2e">Casio@gmail.com</span></a><br/>
...
<g>
                                    ...
                                    <div class="icon-box-text last-reset">
                                        ...
                                        <p class="txt-footer1"><a class="txt-footer1" href="skype:demonhunterp?chat">Casio Offical</a></p>
                ...
                <div class="container clearfix">
                    ...
                    <div class="footer-primary pull-left">
                        <div class="copyright-footer">
                            © Bản quyền thuộc về
                            <công ty khách hàng>. Thiết kế website <img src="./assets/images/images_home/logo_casio.png" style="width:70px;vertical-align:sub;" alt="Menly"> </div>
                    </div>
                    <!-- .left -->
                </div>
                <!-- .container -->
